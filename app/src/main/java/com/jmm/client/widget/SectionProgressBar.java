...
public class SectionProgressBar extends View {
    ...
    private static final float DEFAULT_FIRST_POINT_WIDTH = 3f;
    ...
    private void init(Context paramContext) {
        ...
        mFirstPointPaint.setColor(Color.parseColor("#27FF14"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBreakPointList.isEmpty() || mBreakPointList.getLast() <= mFirstPointTime) {
            canvas.drawRect(mPixelUnit * mFirstPointTime, 0, mPixelUnit * mFirstPointTime + DEFAULT_FIRST_POINT_WIDTH, getMeasuredHeight(), mFirstPointPaint);
        }
    ...
    public int getFirstPoint() {
        return (int) (mPixelUnit * mFirstPointTime);
    }
}